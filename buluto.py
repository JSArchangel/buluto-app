...
width:600px;
height:600px;
background: radial-gradient(circle, rgba(255,255,200,0.9) 0%, rgba(255,255,200,0.2) 40%, transparent 70%);
filter: blur(80px);
z-index:0;
animation:sunPulse 12s infinite alternate;
}
...
.cloud1{top:8%; animation-duration:110s;}
.cloud2{top:25%; animation-duration:150s;}
.cloud3{top:45%; animation-duration:190s;}
.cloud4{top:70%; animation-duration:230s;}
